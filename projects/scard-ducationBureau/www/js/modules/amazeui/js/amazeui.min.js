...
define(function(require, exports, module) {
    ...
    var css = require('css');
    if(!css.isLoad('amazeui.flat.min.css') && !css.isLoad('amazeui.flat.css') && !css.isLoad('amazeui.css') && !css.isLoad('amazeui.min.css')) {
        alert('请加载Amaze UI的样式表');
    }
