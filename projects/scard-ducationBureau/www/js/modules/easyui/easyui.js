...
define(function(require, exports, module) {
    var jQuery = require('$');
    var theme = getQueryParam('theme') || window.EASYUI_DEFAULT_THEME || 'default';
    var css = require('css');

    function _loadTheme(theme) {
        var path = module.uri.substring(0, module.uri.lastIndexOf('/'));
        var mainCSS = path + '/themes/' + theme + '/easyui.css';
        var iconCSS = path + '/themes/icon.css';
        var colorCSS = path + '/themes/color.css';
        css.load(mainCSS);
        css.load(iconCSS);
        css.load(colorCSS);
    }
