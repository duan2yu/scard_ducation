	...
	(function (window, document, plupload, o, $) {
		...
		function renderUI(obj) {
			...
			obj.html(
				...
				'<div class="plupload_header_text">' + _("请选择文件并点击开始上传按钮") + '</div>' +
				'<div class="plupload_view_switch">' +
				'<input type="radio" id="' + obj.id + '_view_list" name="view_mode_' + obj.id + '" checked="checked" /><label class="plupload_button" for="' + obj.id + '_view_list" data-view="list">' + _('列表') + '</label>' +
				'<input type="radio" id="' + obj.id + '_view_thumbs" name="view_mode_' + obj.id + '" /><label class="plupload_button"  for="' + obj.id + '_view_thumbs" data-view="thumbs">' + _('图片') + '</label>' +
				'</div>' +
				'</div>' +
				'</div>' +
				...
				'<tr>' +
				'<td class="plupload_cell plupload_file_name">' + _('文件名') + '</td>' +
				'<td class="plupload_cell plupload_file_status">' + _('状态') + '</td>' +
				'<td class="plupload_cell plupload_file_size">' + _('大小') + '</td>' +
				'<td class="plupload_cell plupload_file_action">&nbsp;</td>' +
				'</tr>' +
				'</table>' +

				'<div class="plupload_content">' +
				'<div class="plupload_droptext">' + _("拖拽文件到此处.") + '</div>' +
				...
				'<a class="plupload_button plupload_add">' + _("添加文件") + '</a>&nbsp;' +
				'<a class="plupload_button plupload_start">' + _("开始上传") + '</a>&nbsp;' +
				'<a class="plupload_button plupload_stop plupload_hidden">' + _("停止上传") + '</a>&nbsp;' +
				'</div>' +
